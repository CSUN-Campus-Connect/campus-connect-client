// src/app/StudentRecCenter/SportClubs/page.tsx
"use client";
      ...
      >
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "40px 16px 28px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap", marginBottom: 10 }}>
            ...
            {/* SrcStatusBadge is a React component; render inline via wrapper */}
            <SrcStatusBadge />
          </div>
        ...
        >
          ...
          >
            ...
            <div style={{ position: "relative", width: 220, flexShrink: 0 }}>
              <svg
                style={{ position: "absolute", left: 10, top: "50%", transform: "translateY(-50%)", width: 14, height: 14, color: "rgb(255, 255, 255)", pointerEvents: "none" }}
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      ...(active
                        ? { backgroundColor: c === "All" ? "#fff" : color, color: c === "All" ? RED : "#fff", boxShadow: `0 2px 10px ${color}55`, transform: "scale(1.06)" }
                        : { backgroundColor: "rgba(255,255,255,0.1)", color: "rgba(255,255,255,0.6)" }),
                    }}
                  >
                    {c !== "All" && <CategoryIcon category={c as Category} size={10} style={{ flexShrink: 0 }} />}
                    {c}
                  </button>
                );
              })}
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "28px 16px 60px" }}>
          {filtered.length === 0 ? (
            <div style={{ textAlign: "center", padding: "80px 0" }}>
              <div style={{ width: 60, height: 60, borderRadius: 16, background: "rgba(255,255,255,0.08)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24, margin: "0 auto 14px" }}>
                🔍
              </div>
              <p style={{ color: "rgba(255,255,255,0.6)", fontWeight: 900, fontSize: 18, margin: "0 0 6px" }}>
                No clubs found
              </p>
              ...
              <button
                ...
                style={{ background: "none", border: "none", cursor: "pointer", color: "rgba(255,255,255,0.5)", fontSize: 12, fontWeight: 700, textDecoration: "underline", textUnderlineOffset: 3, fontFamily: "inherit" }}
              >
                Clear filters
              </button>
            </div>
