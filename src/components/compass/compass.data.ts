...
export const ALL_MILESTONES: CompassMilestone[] = [
  // ── CRITICAL FIRST-WEEK ACTIONS ──────────────────────────────────────────
  {
    ...
    resources: [
      ...
      { name: 'SOLAR Student Portal', url: 'https://www.csun.edu/solar', note: 'Schedule appointments and view your DPR online' },
    ],
  ...
  },
  {
    ...
    resources: [
      { name: 'CSUN Financial Aid', url: 'https://www.csun.edu/financialaid', location: 'Bayramian Hall 200', phone: '(818) 677-4085' },
      { name: 'CSUN Scholarship Portal', url: 'https://csun.academicworks.com', note: 'Hundreds of scholarships, many for specific majors and backgrounds' },
      { name: 'Emergency Funds', url: 'https://www.csun.edu/studentaffairs/dean-of-students', note: 'CSUN has emergency funds for unexpected financial hardship' },
    ],
  ...
  // ── IDENTITY / BELONGING ─────────────────────────────────────────────────
  {
    ...
    resources: [
      { name: 'CSUN Clubs & Orgs', url: 'https://www.csun.edu/studentaffairs/campus-life/clubs', note: '500+ student organizations on campus' },
      { name: 'Matador Involvement Center', url: 'https://www.csun.edu/usu/mic', location: 'USU 112', phone: '(818) 677-5111' },
    ],
  ...
  // ── CAREER MILESTONES ────────────────────────────────────────────────────
  {
    ...
    resources: [
      ...
      { name: 'Handshake - CSUN Jobs', url: 'https://csun.joinhandshake.com', note: 'Free internship and job board specifically for CSUN students' },
    ],
  ...
  },
  {
    ...
    resources: [
      { name: 'CSUN URCA Program', url: 'https://www.csun.edu/undergraduate-studies/urca', note: 'Paid undergraduate research with CSUN faculty' },
      { name: 'Handshake', url: 'https://csun.joinhandshake.com' },
      { name: 'Parker Dewey Micro-Internships', url: 'https://parkerdewey.com', note: 'Short professional projects — great for building experience' },
    ],
  ...
  // ── SOPHOMORE PIVOT ──────────────────────────────────────────────────────
  {
    ...
    resources: [
      ...
      { name: 'CSUN Career Center Major/Career Exploration', url: 'https://www.csun.edu/careercenter' },
    ],
    linkedFeature: 'Social Feed / Alumni Network',
  },
