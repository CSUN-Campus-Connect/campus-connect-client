...
export const ALL_MILESTONES: CompassMilestone[] = [
  ...
  },
  {
    ...
    resources: [
      ...
      { name: 'CSUN Scholarship Portal', url: 'https://www.csun.edu/scholarships', note: 'Hundreds of scholarships - many go unclaimed' },
      { name: 'Emergency Assistance Fund', url: 'https://www.csun.edu/cashiers/emergency-funds-and-loans', note: 'Emergency grants for unexpected financial hardship' },
  ...
  // ── IDENTITY / BELONGING ─────────────────────────────────────────────────
  {
    ...
    resources: [
      ...
      { name: 'Matador Involvement Center', url: 'https://www.csun.edu/student-union', location: 'University Student Union - Lower Level', phone: '(818) 677-5111' },
      { name: 'Student Life Events', url: 'https://www.csun.edu/student-life', note: 'Weekly involvement fairs and networking events' },
      { name: 'Transfer Student Resources', url: 'https://www.csun.edu/admissions', note: 'Special communities and support for transfer students' },
    ],
  ...
  // ── CAREER MILESTONES ────────────────────────────────────────────────────
  {
    ...
    resources: [
      { name: 'CSUN Career Center', url: 'https://www.csun.edu/career-center', location: 'University Hall 100', phone: '(818) 677-2878', hours: 'Mon-Fri 8am-5pm' },
      { name: 'Handshake (CSUN Jobs)', url: 'https://csun.joinhandshake.com', note: 'Free internship and job board - CSUN-exclusive recruiting' },
      { name: 'CSUN Alumni Network', url: 'https://www.csun.edu/alumni', note: 'Connect with 280,000+ Matadors in your field' },
  ...
  },
  {
    ...
    resources: [
      { name: 'CSUN URCA Program (Paid Research)', url: 'https://www.csun.edu/research/urca', note: 'Paid undergraduate research opportunities with CSUN faculty' },
      { name: 'Handshake (Internship Board)', url: 'https://csun.joinhandshake.com', note: 'Filter by internships and experience level' },
      { name: 'CSUN Internship Programs', url: 'https://www.csun.edu/career-center', note: 'Structured internship pathways by college' },
  ...
  // ── MENTAL HEALTH ────────────────────────────────────────────────────────
  {
    ...
    resources: [
      { name: 'CSUN Counseling Services', url: 'https://www.csun.edu/counseling', location: 'Klotz Student Health Center, Building 200', phone: '(818) 677-2366', hours: 'Mon-Fri 8am-5pm', note: 'FREE and confidential for enrolled students' },
      { name: 'CSUN Student Health', url: 'https://www.csun.edu/health', phone: '(818) 677-5899', note: 'Mental wellness workshops and resources' },
  ...
  // ── SOPHOMORE PIVOT ──────────────────────────────────────────────────────
  {
    ...
    resources: [
      { name: 'CSUN Undergraduate Advising', url: 'https://www.csun.edu/advising', note: 'For undecided students - take time to explore, not a setback' },
      { name: 'Career Exploration Tool', url: 'https://www.csun.edu/career-center', note: 'Assess majors based on job outlook and salary' },
      { name: 'Meet Your Department Advisor', url: 'https://www.csun.edu/advising', note: 'Talk before committing to avoid costly mistakes' },
      { name: 'Course Catalog', url: 'https://catalog.csun.edu', note: 'View course requirements and major pathways' },
    ],
    linkedFeature: 'Social Feed / Alumni Network',
  },
  ...
  // ── LINKEDIN & PROFESSIONAL IDENTITY ────────────────────────────────────
  {
    ...
    resources: [
      { name: 'CSUN Career Center LinkedIn Help', url: 'https://www.csun.edu/career-center', note: 'Free professional headshots and LinkedIn profile reviews' },
  ...
  // ── FINANCIAL LITERACY ───────────────────────────────────────────────────
  {
    ...
    resources: [
      ...
      { name: 'CSUN Financial Wellness', url: 'https://www.csun.edu/student-support/financial-wellness', note: 'Free workshops on budgeting, loans, and credit' },
    ],
    linkedFeature: 'Dashboard',
  },
];
